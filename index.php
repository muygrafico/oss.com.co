...
<body>
  ...
  <div id='home-page'>
    ...
    <section class='container'>
      <div class='row'>
        <div class='col-sm-4'>
          <h4 class='subtitle'>Oilfield Services & Supplies S.A.S.</h4>
          <img src='images/home/oilfield-services-oss.jpg' class='img-responsive' alt='' />
        </div>
        <div class='col-sm-8'>
          <h4 class='subtitle side-margins'>Nuestro Portafolio de Servicios:</h4>
          <div class='col-sm-6'>
            <h5 class='subtitle'>Medición Multifásica para pruebas de pozos</h5>
            <p>
          ...
          <div class='col-sm-6'>
            <h5 class='subtitle'>Servicios de Bombeo de Fluidos Downhole</h5>
            <p>
      ...
      <div class='row'>
        ...
        <div class='col-sm-8'>
          ...
          <div class='col-sm-6'>
            <h5 class='subtitle'>Facilidades Tempranas y Manejo de Aguas de Producción</h5>
            <p>
          ...
          <div class='col-sm-6'>
            <h5 class='subtitle'>Generación de energía eléctrica con generadores con motores a gas</h5>
            <p>
      ...
      <div class='row'>
        <div class='col-sm-4'>
          ...
          <a class='button' href='#'>Conoce más sobre OSS</a>
        </div>
      </div>
    </section>
    ...
    <section class='container alliances'>
      <div class='row'>
        <div class='col-sm-12'>
          <h4 class='subtitle pipes'>A Haimo group company</h4>
        </div>
      </div>
      <div class='row'>
        <div class='col-sm-12 text-center'>
          <ul class='alliances-logos'>
            <li><a href='#'><img src='images/home/haimo-logo.jpg' alt='' /></a></li>
          </ul>
        </div>
      </div>
      <br>
