    ...
    <div class='container'>
      <div class='row text-center'>
        <div class="col-md-6 col-md-offset-3">
          ...
          <p class='values-text'>
            <strong>We do things good for our people, our environment and our society,but especially for our clients.</strong>
          </p>
        </div>
      </div>
      ...
      <div class='row'>
        ...
        <div class='col-sm-6'>
          <h4 class='subtitle pipes'>Historical Review - OSS</h4>
          <p>
        ...
        <div class='col-sm-6 text-center'>
          <h4 class='subtitle pipes'>Our Values</h4>
          <h6>Leadership</h6>
          <p class='values-text'>The courage to shape a better future led by example.</p>
          <h6>Integrity</h6>
          <p class='values-text'>Be real and foremost, act with integrity.</p>
          <h6>Responsibility</h6>
          <p class='values-text'>If it is to commit, it is for me.</p>
          <h6>Passion</h6>
          <p class='values-text'>Committed in mind and heart.</p>
          <h6>Quality</h6>
          <p class='values-text'>We do things right the first time.</p>
          <div class='values-green-box'>
            <ul class='values-list'>
              <li>We work together</li>
              <li>We respect the individual</li>
              <li>We communicate openly and honestly</li>
              <li>We engage with the community</li>
            </ul>
          </div>
        </div>
      ...
      <div class='row margin-tb-2'>
        <div class='col-sm-6 col-sm-push-6'>
          ...
          <p class='vision-point'>
            <strong>Porfolio of products and services:</strong>
            Offer to our clients a selected portfolio of services and products with new technology to provide integral solutions to their needs with best level of quality and safety.
          </p>

          <p class='vision-point'>
            <strong>Allies:</strong>
            Grow a strong network of clients and suppliers that working along will allow us to create added value and long-term mutual benefits.
          </p>

          <p class='vision-point'>
            <strong>Profitability:</strong>
            Maximize the Return of Investment of our shareholders, while maintaining integrity in all our work and responsibilities.
          </p>

          <p class='vision-point'>
            <strong>Community support:</strong>
             Contribute to the social development of the communities where we operate ensuring the preservation of the environment.
          </p>
